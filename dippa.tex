...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Elements of successful pre-procurement knowledge sharing between SME service suppliers and public procurer}
...
\section{Procurement law}

\section{SME's in public procurement}
In this chapter I will introduce to you the SME's role in public procurement. 

\section{VISO project}
...
2.1.	SME’s in public procurement
2.1.1.	Public procurement Act
2.1.2.	Factors that inhibit successful tendering process
2.1.3.	Factors that encourage a successful tendering process
2.2.	From product dominant logic to service dominant logic
2.2.1.	…
2.2.2.	….
2.3.	Visualizing/co-design methods
2.4.	Theoretical framework
3.	Research process
4.	Results
4.1.	Categorization according to theoretical framework
5.	Conclusions
6.	Summary
References
