...
The service dominant logic is a perspective on marketing, originally introduced by Vargo and Lusch (2004). It is not a theory, but a mindset or a lens through which to look at social and economic exchange phenomena (Vargo & Lusch 2008a). This new dominant logic is moving away from product-centered viewpoint, described as goods-dominant view. In goods-dominant view, the tangible output and discrete transactions are central. Thus, the way product and service offerings have been marketed and sold, has concentrated on the physical, measurable product and transactions related to it. (Vargo & Lusch 2004) Even service companies often do very product-oriented marketing (Shostack 1977).
