...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Elements of successful pre-procurement knowledge sharing between service suppliers and public procure}
\newcommand{\FTITLE}{Suomeksi aihe}
\newcommand{\STITLE}{Ruotsiksi aihe}
\newcommand{\SUBTITLE}{Method for fulfilling user needs}
\newcommand{\FSUBTITLE}{Metodi tarveperusteisiin hankintoihin}
\newcommand{\SSUBTITLE}{pä svenska}
\newcommand{\DATE}{June 18, 2013}
\newcommand{\FDATE}{18. kesäkuuta 2013}
\newcommand{\SDATE}{Den 18 Juni 2013}
...
\newcommand{\INSTRUCTOR}{Soile Pohjonen title}
\newcommand{\FINSTRUCTOR}{titteli Soile Pohjonen}
\newcommand{\SINSTRUCTOR}{ Soile Pohjonen}
